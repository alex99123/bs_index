            ...
            case 0:
                $('.modalBody').html('<p class="mainPararaph"><b>运维托管解决方案</b></p>' +
                    ...
                    '<div class="subContent">' +
                        ...
                        '<p><b>监控管理：</b>通过CloudWatch、Cloudtrail或者第三方Splunk、EKK等方案实现对各类AWS托管服务的状态进行监控，确保业务运行状态良好且稳定，并在故障发生时及时通过短信、邮件等方式通知运维人员；对API与用户行为进行监控与审计等，确保所有资源与数据的安全和可靠，在万一出现不知名故障或恶意操作时能够及时响应与报警。</p>' +
                    ...
                    '</div>' +
                    '<p class="mainPararaph"><b>应用场景：</b>博思云为拥有多年丰厚的AWS运维服务经验，为IT科技公司、制造业、银行、金融等众多企业客户提供过解决方案与运维管理服务。无论简单还是复杂的业务体系结构，我们都将为客户提供高质量的服务，帮助客户解决在AWS上遇到的所有问题，确保客户的业务在云上稳定、良好的运行。</p>' +
                    '<p class="mainPararaph"><b>方案优势：</b>博思云为竭诚为客户提供专业的、高可靠性的，完善的一站式运维服务。为客户在AWS上业务架构、安全、运维、应急响应、业务/架构/使用优化等服务，确保每一位客户的业务在稳定、可靠的前提下，省心、省力、省钱的运行。</p>'
                )
                break;
            case 1:
